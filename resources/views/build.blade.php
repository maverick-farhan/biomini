     ...
     <div class="container mt-5">
       <div class="row">
        <div class="col-12 form-div">
            ...
            <form method="POST" action="{{ route('building') }}" enctype="multipart/form-data">
                @csrf
                <div class="image text-center">
                    <img class="img-circle mx-auto img-responsive d-block img-fluid img-thumbnail height: auto;" src="" alt="profile picture" id="profile_img" />
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ old('name') }}" required class="form-control" id="username" name="name" placeholder="John Doe">
                    <br />
                    <span style="color:red;">
                        @error('name')
                            {{ $message }}
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="profession" required class="form-control" id="profession" placeholder="Product Manager" value="{{ old('profession') }}" />
                    <br />
                    <span style="color:red;">
                        @error('profession')
                            {{ $message }}
                ...
                <div class="mb-3">
                  ...
                  <input type="email" required class="form-control" id="email" name="email" placeholder="johndoe@email.com" value="{{ old('email') }}" />
                  <br />
                  <span style="color:red;">
                      @error('email')
                          {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="phone" required class="form-control" id="phone" placeholder="9000000001"  value="{{ old('phone') }}" />
                    <br />
                    <span style="color:red;">
                        @error('phone')
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <input type="url" name="website" required class="form-control" id="website" placeholder="www.johndoe.com" value="{{ old('website') }}" />
                    <br />
                    <span style="color:red;">
                        @error('website')
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <input type="url" name="portfolio" required class="form-control" id="portfolio" placeholder="www.portfolio.johndoe.com" value="{{ old('portfolio') }}" >
                    <br />
                    <span style="color:red;">
                        @error('portfolio')
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <input type="url" value="{{ old('ig') }}" name="ig" required class="form-control" id="ig" placeholder="https://www.instagram.com/cristiano/">
                    <br />
                    <span style="color:red;">
                        @error('ig')
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <input type="url" name="fb" value="{{ old('fb') }}" required class="form-control" id="fb" placeholder="https://www.facebook.com/fordmustang/">
                    <br />
                    <span style="color:red;">
                        @error('fb')
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <input type="url" name="twitter" value="{{ old('twitter') }}" required class="form-control" id="twitter" placeholder="https://x.com/elonmusk">
                    <br />
                    <span style="color:red;">
                        @error('twitter')
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <input type="url" name="ldin" required value="{{ old('ldin') }}" class="form-control" id="ldin" placeholder="https://www.linkedin.com/in/sundarpichai/">
                    <br />
                    <span style="color:red;">
                        @error('ldin')
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="resume" value="{{ old('resume') }}" required class="form-control" id="resume" accept=".pdf" />
                    <br />
                    <span style="color:red;">
                        @error('resume')
                            {{ $message }}
